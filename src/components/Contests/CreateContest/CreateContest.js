                    ...
                    <Col span={12} xs={24} className="Wrapper">
                        ...
                        <form>
                            <div className="form-group">
                                ...
                                <input type="text" className="lc__input" />
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group">
                                <label htmlFor="">Add Image or video</label>
                                <Dragger {...props}>
                            ...
                            <div className="form-group">
                                ...
                                <p className="terms">
                                    ...
                                    discover talents. What are you waiting for?
                                </p>
                            </div>
...
export default styled(CreateContest)`
    background-color: #f4f4f4;
    .CreateContest-Container {
        padding-top: 40px;
